...
// Quit records a user or model quitting the server. One event
// is recorded per channel the actor was in. See `Join` for
...
// NickChange records a nick change visible in a channel.
