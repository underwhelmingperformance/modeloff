...
var llmScopedAttrs = map[string]string{
	...
	"AttrContextLength":    AttrContextLength,
	"AttrPromptLimit":      AttrPromptLimit,
	"AttrPromptEstimate":   AttrPromptEstimate,
	"AttrRequestBytes":     AttrRequestBytes,
	"AttrContextFits":      AttrContextFits,
