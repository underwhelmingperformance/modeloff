...
func TestSQLiteStore_stamps_revision_zero_with_the_registration_time(t *testing.T) {
	...
	require.NoError(t, stored.SaveModelInstance(t.Context(), instance, createdAt))
